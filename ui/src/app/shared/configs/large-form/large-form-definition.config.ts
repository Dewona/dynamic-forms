...
export let largeFormDefinitionConfig = [
  ...
  { id: 9, label: 'Large_1', key: 'large_1', value: '', type: 'textbox', pattern: maxLengthPattern },
  { id: 10, label: 'Large_2', key: 'large_2', value: '', type: 'textbox', pattern: maxLengthPattern },
  { id: 11, label: 'Large_3', key: 'large_3', value: '', type: 'textbox', pattern: maxLengthPattern }
];
